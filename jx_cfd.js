...
// 探险寻宝
async function treasuresHunt() {
  let treasures = ['tree', 'wood', 'small_stone'];
  for (let strIndex of treasures) {
    await TreasureHunt(strIndex);
  }
}
...
function GetMoney() {
  # GET /jxcfd/user/GetMoney?strZone=jxcfd&bizCode=jxcfd&source=jxcfd&dwEnv=7&_cfd_t=1606638545899&ptag=138631.26.55&dwSceneId=1001&strEmployeeId=undefined&dwSource=1&_=1606638545899&sceneval=2&g_login_type=1&callback=jsonpCBKAA&g_ty=ls
